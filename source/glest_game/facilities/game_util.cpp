...
#  endif
	...
	string getAboutString1(int i) {
		...
		switch (i) {
			...
			case 3:
				return "Copyright 2018 The ZetaGlest Team";
		}
		return "";
	}
	...
	string getAboutString2(int i) {
		switch (i) {
			...
			case 2:
				return "IRC: irc://irc.freenode.net/zegaglest-dev";
		}
		return "";
	}
	...
	string getTeammateRole(int i) {
		...
		switch (i) {
			...
			case 7:
				return lang.getString("Megaglest3d2dProgramming");
			case 8:
				return lang.getString("MegaglestProgramming");
		}
		return "";
	}
