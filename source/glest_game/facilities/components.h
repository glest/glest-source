...
namespace Glest {
	namespace Game {
		...
		public:
			...
			string getFontCallbackName() const {
				return fontCallbackName;
			}
			...
			virtual Font2D *getFont() {
				return font;
			}
			virtual Font3D *getFont3D() {
				return font3D;
			}
		...
		public:
			...
			vector<int> getTextCharLengthList() const {
				return textCharLength;
			}
			void setTextCharLengthList(vector<int> value) {
				textCharLength = value;
			}
			void clearTextCharLengthList() {
				textCharLength.clear();
			}
			void addTextCharLengthToList(int length) {
				textCharLength.push_back(length);
			}
			void deleteTextCharLengthFromList() {
			...
			void setMaxEditWidth(int value) {
				maxEditWidth = value;
			}
			int getMaxEditWidth() const {
				return maxEditWidth;
			}
			...
			Vec4f getBackgroundColor() const {
				return backgroundColor;
			}
			void setBackgroundColor(Vec4f color) {
				this->backgroundColor = color;
			}

			void setMaxEditRenderWidth(int value) {
				maxEditRenderWidth = value;
			}
			int getMaxEditRenderWidth() const {
				return maxEditRenderWidth;
			}
		...
		public:
			...
			bool getUseCustomTexture() const {
			...
			void setUseCustomTexture(bool value) {
				useCustomTexture = value;
			}
			void setCustomTexture(Texture *value) {
				customTexture = value;
			}

			bool getLighted() const {
				return lighted || alwaysLighted;
			}
			void setLighted(bool lighted) {
				this->lighted = lighted;
			}
			bool getAlwaysLighted() const {
				return alwaysLighted;
			}
			void setAlwaysLighted(bool value) {
				this->alwaysLighted = value;
			}
			virtual bool mouseMove(int x, int y);
		};
		...
		public:
			...
			GraphicButton *getButton1() {
				return &graphButton1;
			}
			GraphicButton *getButton2() {
				return &graphButton2;
			}
			bool getLighted() const {
				return lighted;
		...
		public:
			...
			bool getAutoWordWrap() const {
				return autoWordWrap;
			}
			void setAutoWordWrap(bool value) {
				autoWordWrap = value;
			}
			...
			GraphicButton *getButton(int index) {
		...
		public:
			...
			void setLength(int length) {
				horizontal ? setW(length) : setH(length);
			}
			...
			int getVisibleEnd() const {
				return visibleStart + visibleSize > elementCount - 1 ? elementCount - 1 : visibleStart + visibleSize - 1;
			}
			void setVisibleStart(int visibleStart);

			int getVisibleCompPosStart() const {
				return visibleCompPosStart;
			}
			int getVisibleCompPosEnd() const {
				return visibleCompPosEnd;
			}
		...
		public:
			...
			std::vector<GraphicButton> & getMenuItems() {
				return buttons;
			}
			string getHeader() const {
				return header;
