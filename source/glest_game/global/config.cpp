...
namespace Game {
	...
	Config::Config(std::pair < ConfigType, ConfigType > type,
		...
		if (foundPath == false) {
			foundPath =
				tryCustomPath(cfgType, fileName, "/usr/share/zetaglest/");
		}
		if (foundPath == false) {
			foundPath =
				tryCustomPath(cfgType, fileName, "/usr/share/games/zetaglest/");
		}
		if (foundPath == false) {
			foundPath =
				tryCustomPath(cfgType, fileName, "/usr/local/share/zetaglest/");
		}
		if (foundPath == false) {
			foundPath =
				tryCustomPath(cfgType, fileName,
					"/usr/local/share/games/zetaglest/");
		}
#endif
