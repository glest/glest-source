...
namespace Glest {
	namespace Game {
		...
		public:
			...
			inline TextRenderer2D *getTextRenderer() const {
				return textRenderer;
			}
			inline TextRenderer3D *getTextRenderer3D() const {
				return textRenderer3D;
			}
			...
			inline Quad2i getVisibleQuad() const {
				return visibleQuad;
			}
			inline Quad2i getVisibleQuadFromCamera() const {
				return visibleQuadFromCamera;
			}
			...
			inline bool getNo2DMouseRendering() const {
				return no2DMouseRendering;
			}
			void setNo2DMouseRendering(bool value) {
				no2DMouseRendering = value;
			}

			inline bool getShowDebugUI() const {
				return showDebugUI;
			}
			void setShowDebugUI(bool value) {
				showDebugUI = value;
			}

			inline int getShowDebugUILevel() const {
				return showDebugUILevel;
			}
			void setShowDebugUILevel(int value) {
				showDebugUILevel = value;
			}
			void cycleShowDebugUILevel();

			void setLastRenderFps(int value);
			inline int getLastRenderFps() const {
			...
			inline int getCachedSurfaceDataSize() const {
				return (int) mapSurfaceData.size();
			}
			...
			void setCustom3dMenu(const MainMenu *mm) {
				this->custom_mm3d = mm;
			}
			const MainMenu * getCustom3dMenu() {
				return this->custom_mm3d;
			}
