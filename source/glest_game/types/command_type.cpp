...
namespace ZetaGlest {
	namespace Game {
		...
		void CommandType::load(int id, const XmlNode * n, const string & dir,
			...
			const UnitType & ut, std::map < string,
			vector < pair < string,
			string > > >&loadedFileList, string parentLoader) {
			...
			this->id = id;
			name =
				n->getChild("name")->getAttribute("value")->getRestrictedValue();
			...
			loadedFileList[imageNode->getAttribute("path")->
				...
				push_back(make_pair
				(parentLoader,
					imageNode->getAttribute("path")->getRestrictedValue()));
			...
			const XmlNode *upgradeRequirementsNode =
				n->getChild("upgrade-requirements");
			...
			if (n->hasChild("fog-of-war-skill") == true) {
				string skillName =
					n->getChild("fog-of-war-skill")->getAttribute("value")->
					getRestrictedValue();
				fogOfWarSkillType =
					static_cast <
					const FogOfWarSkillType *>(ut.getSkillType(skillName, scFogOfWar));

				string skillAttachmentNames =
					n->getChild("fog-of-war-skill")->
					getAttribute("skill-attachments")->getValue();
		...
		bool CommandType::hasFogOfWarSkillType(string name) const {
			std::map < string, bool >::const_iterator iterFind =
				fogOfWarSkillAttachments.find(name);
		...
		void StopCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateStop(unit, frameIndex);
		}

		string StopCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			...
			str +=
				lang.getString("ReactionSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(stopSkillType->getSpeed()) + "\n";
			if (stopSkillType->getEpCost() != 0)
				str +=
				lang.getString("EpCost",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(stopSkillType->getEpCost()) + "\n";
			if (stopSkillType->getHpCost() != 0)
				str +=
				lang.getString("HpCost",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(stopSkillType->getHpCost()) + "\n";
		...
		void StopCommandType::load(int id, const XmlNode * n, const string & dir,
			...
			//stop
			string skillName =
				n->getChild("stop-skill")->getAttribute("value")->
				getRestrictedValue();
			stopSkillType =
				static_cast <
				const StopSkillType *>(ut.getSkillType(skillName, scStop));
		}
		...
		void MoveCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
		...
		void MoveCommandType::load(int id, const XmlNode * n, const string & dir,
			...
			//move
			string skillName =
				n->getChild("move-skill")->getAttribute("value")->
				getRestrictedValue();
			moveSkillType =
				static_cast <
				const MoveSkillType *>(ut.getSkillType(skillName, scMove));
		}

		string MoveCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str;
			Lang & lang = Lang::getInstance();
			...
			str = getName(translatedValue) + "\n";
			str +=
				lang.getString("WalkSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(moveSkillType->getSpeed());
			...
			if (moveSkillType->getEpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(moveSkillType->getEpCost()) + "\n";
			}
			if (moveSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(moveSkillType->getHpCost()) + "\n";
			}
		...
		void AttackCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateAttack(unit, frameIndex);
		}

		void AttackCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft, const UnitType & ut,
			...
			//attack
			skillName =
				n->getChild("attack-skill")->getAttribute("value")->
				getRestrictedValue();
			attackSkillType =
				static_cast <
				const AttackSkillType *>(ut.getSkillType(skillName, scAttack));
		}

		string AttackCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str;
			Lang & lang = Lang::getInstance();
			...
			if (attackSkillType->getEpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(attackSkillType->getEpCost()) + "\n";
			}
			if (attackSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(attackSkillType->getHpCost()) + "\n";
			}

			//attack strength
			str +=
				lang.getString("AttackStrenght",
				(translatedValue == true ? "" : "english")) + ": ";
			str +=
				intToStr(attackSkillType->getAttackStrength() -
					attackSkillType->getAttackVar());
			str += "...";
			str +=
				intToStr(attackSkillType->getAttackStrength() +
					attackSkillType->getAttackVar());
			if (totalUpgrade->getAttackStrength(attackSkillType) != 0) {
				str +=
					"+" + intToStr(totalUpgrade->getAttackStrength(attackSkillType));
			}
			str +=
				" (" + attackSkillType->getAttackType()->getName(translatedValue) +
				")";
			str += "\n";
			...
			//attack distance
			str +=
				lang.getString("AttackDistance",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(attackSkillType->getAttackRange());
			if (totalUpgrade->getAttackRange(attackSkillType) != 0) {
				str +=
					"+" + intToStr(totalUpgrade->getAttackRange(attackSkillType));
			}
			str += "\n";
			...
			//attack speed
			str +=
				lang.getString("AttackSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(attackSkillType->getSpeed()) + "\n";
			if (totalUpgrade->getAttackSpeed(attackSkillType) != 0) {
				str +=
					"+" + intToStr(totalUpgrade->getAttackSpeed(attackSkillType));
			}
			str += "\n";
		...
		void AttackStoppedCommandType::update(UnitUpdater * unitUpdater,
			Unit * unit, int frameIndex) const {
			unitUpdater->updateAttackStopped(unit, frameIndex);
		}

		void AttackStoppedCommandType::load(int id, const XmlNode * n,
			const string & dir,
			const TechTree * tt,
		...
		string AttackStoppedCommandType::getDesc(const TotalUpgrade *
			totalUpgrade,
			bool translatedValue) const {
			Lang & lang = Lang::getInstance();
			string str;
		...
		BuildCommandType::~BuildCommandType() {
			deleteValues(builtSounds.getSounds().begin(),
				builtSounds.getSounds().end());
			deleteValues(startSounds.getSounds().begin(),
				startSounds.getSounds().end());
		}

		void BuildCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateBuild(unit, frameIndex);
		}

		void BuildCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft, const UnitType & ut,
			std::map < string, vector < pair < string,
			string > > >&loadedFileList,
			...
			//build
			skillName =
				n->getChild("build-skill")->getAttribute("value")->
				getRestrictedValue();
			buildSkillType =
				static_cast <
				const BuildSkillType *>(ut.getSkillType(skillName, scBuild));
			...
			for (int i = 0; i < (int) buildingsNode->getChildCount(); ++i) {
				...
				string name =
					buildingNode->getAttribute("name")->getRestrictedValue();
			...
			if (startSoundNode->getAttribute("enabled")->getBoolValue()) {
				...
				for (int i = 0; i < (int) startSoundNode->getChildCount(); ++i) {
					const XmlNode *soundFileNode =
						startSoundNode->getChild("sound-file", i);
					string currentPath = dir;
					endPathWithSlash(currentPath);
					string path =
			...
			if (builtSoundNode->getAttribute("enabled")->getBoolValue()) {
				...
				for (int i = 0; i < (int) builtSoundNode->getChildCount(); ++i) {
					const XmlNode *soundFileNode =
						builtSoundNode->getChild("sound-file", i);
					string currentPath = dir;
					endPathWithSlash(currentPath);
					string path =
						soundFileNode->getAttribute("path")->
		...
		string BuildCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str;
			Lang & lang = Lang::getInstance();
			...
			str +=
				...
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(buildSkillType->getSpeed()) + "\n";
			if (buildSkillType->getEpCost() != 0) {
				str +=
					lang.getString("EpCost",
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(buildSkillType->getEpCost()) + "\n";
			}
			if (buildSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(buildSkillType->getHpCost()) + "\n";
			}
		...
		void HarvestCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateHarvest(unit, frameIndex);
		}

		void HarvestCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft,
			const UnitType & ut, std::map < string,
			vector < pair < string,
			...
			//harvest
			skillName =
				n->getChild("harvest-skill")->getAttribute("value")->
				getRestrictedValue();
			harvestSkillType =
				static_cast <
				const HarvestSkillType *>(ut.getSkillType(skillName, scHarvest));

			//stop loaded
			skillName =
				n->getChild("stop-loaded-skill")->getAttribute("value")->
				getRestrictedValue();
			stopLoadedSkillType =
				static_cast <
				const StopSkillType *>(ut.getSkillType(skillName, scStop));
			...
			//move loaded
			skillName =
				n->getChild("move-loaded-skill")->getAttribute("value")->
				getRestrictedValue();
			moveLoadedSkillType =
				static_cast <
				const MoveSkillType *>(ut.getSkillType(skillName, scMove));
			...
			for (int i = 0; i < (int) resourcesNode->getChildCount(); ++i) {
				...
				harvestedResources.push_back(tt->
					getResourceType(resourceNode->
						getAttribute("name")->
						getRestrictedValue
						()));
			}
			...
			maxLoad =
				n->getChild("max-load")->getAttribute("value")->getIntValue();
			hitsPerUnit =
				n->getChild("hits-per-unit")->getAttribute("value")->getIntValue();
		}

		string HarvestCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			...
			str = getName(translatedValue) + "\n";
			str +=
				lang.getString("HarvestSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(harvestSkillType->getSpeed() / hitsPerUnit) + "\n";
			str +=
				lang.getString("MaxLoad",
				(translatedValue ==
					true ? "" : "english")) + ": " + intToStr(maxLoad) +
				"\n";
			str +=
				lang.getString("LoadedSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(moveLoadedSkillType->getSpeed()) + "\n";
			if (harvestSkillType->getEpCost() != 0) {
				str +=
					lang.getString("EpCost",
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(harvestSkillType->getEpCost()) + "\n";
			}
			if (harvestSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(harvestSkillType->getHpCost()) + "\n";
			}
			str +=
				lang.getString("Resources",
				(translatedValue == true ? "" : "english")) + ":\n";
		...
		bool HarvestCommandType::canHarvest(const ResourceType * resourceType) const {
			return find(harvestedResources.begin(), harvestedResources.end(),
				resourceType) != harvestedResources.end();
		}
		...
		void HarvestEmergencyReturnCommandType::update(UnitUpdater * unitUpdater,
			Unit * unit,
			int frameIndex) const {
			unitUpdater->updateHarvestEmergencyReturn(unit, frameIndex);
		}

		void HarvestEmergencyReturnCommandType::load(int id, const XmlNode * n,
			const string & dir,
			const TechTree * tt,
			const FactionType * ft,
			const UnitType & ut,
		...
		string HarvestEmergencyReturnCommandType::getDesc(const TotalUpgrade *
			totalUpgrade,
		...
		void RepairCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateRepair(unit, frameIndex);
		}

		void RepairCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft, const UnitType & ut,
			std::map < string, vector < pair < string,
			string > > >&loadedFileList,
			...
			//repair
			string skillName =
				n->getChild("repair-skill")->getAttribute("value")->
				getRestrictedValue();
			repairSkillType =
				static_cast <
				const RepairSkillType *>(ut.getSkillType(skillName, scRepair));
			...
			for (int i = 0; i < (int) unitsNode->getChildCount(); ++i) {
				...
				repairableUnits.push_back(ft->
					getUnitType(unitNode->
						getAttribute("name")->
						getRestrictedValue()));
			}
		...
		string RepairCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			Lang & lang = Lang::getInstance();
			string str;
			...
			str = getName(translatedValue) + "\n";
			str +=
				lang.getString("RepairSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(repairSkillType->getSpeed()) + "\n";
			...
			if (repairSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(repairSkillType->getHpCost()) + "\n";
			}
			str +=
				"\n" + lang.getString("CanRepair",
				(translatedValue ==
					true ? "" : "english")) + ":\n";
			for (int i = 0; i < (int) repairableUnits.size(); ++i) {
				str +=
					(static_cast <
						const UnitType *
					>(repairableUnits[i]))->getName(translatedValue) + "\n";
			}
		...
		bool RepairCommandType::isRepairableUnitType(const UnitType * unitType) const {
			for (int i = 0; i < (int) repairableUnits.size(); ++i) {
				const UnitType *curUnitType =
					static_cast <const UnitType *>(repairableUnits[i]);
		...
		void ProduceCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateProduce(unit, frameIndex);
		}

		void ProduceCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft,
			const UnitType & ut, std::map < string,
			vector < pair < string,
			...
			//produce
			string skillName =
				n->getChild("produce-skill")->getAttribute("value")->
				getRestrictedValue();
			produceSkillType =
				static_cast <
				const ProduceSkillType *>(ut.getSkillType(skillName, scProduce));

			string producedUnitName =
				n->getChild("produced-unit")->getAttribute("name")->
				getRestrictedValue();
		...
		string ProduceCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str = getName(translatedValue) + "\n";
			Lang & lang = Lang::getInstance();
			...
			//prod speed
			str +=
				lang.getString("ProductionSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(produceSkillType->getSpeed());
			if (totalUpgrade->getProdSpeed(produceSkillType) != 0) {
				str += "+" + intToStr(totalUpgrade->getProdSpeed(produceSkillType));
			}
			str += "\n";
			str +=
				"" + Lang::getInstance().getString("TimeSteps",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(getProducedUnit()->getProductionTime()) + "\n";
			int64 speed =
				produceSkillType->getSpeed() +
				totalUpgrade->getProdSpeed(produceSkillType);
			int64 time = getProducedUnit()->getProductionTime();
			int64 seconds = time * 100 / speed;
			str +=
				"" + Lang::getInstance().getString("Time",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(seconds);
			str += "\n";
			...
			if (produceSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(produceSkillType->getHpCost()) + "\n";
			}
		...
		void UpgradeCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateUpgrade(unit, frameIndex);
		}

		void UpgradeCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft,
			const UnitType & ut, std::map < string,
			vector < pair < string,
			...
			//upgrade
			string skillName =
				n->getChild("upgrade-skill")->getAttribute("value")->
				getRestrictedValue();
			upgradeSkillType =
				static_cast <
				const UpgradeSkillType *>(ut.getSkillType(skillName, scUpgrade));

			string producedUpgradeName =
				n->getChild("produced-upgrade")->getAttribute("name")->
				getRestrictedValue();
			producedUpgrade = ft->getUpgradeType(producedUpgradeName);

		}

		string UpgradeCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str;
			Lang & lang = Lang::getInstance();
			...
			str = getName(translatedValue) + "\n";
			str +=
				lang.getString("UpgradeSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(upgradeSkillType->getSpeed());
			...
			str +=
				...
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(getProducedUpgrade()->getProductionTime()) + "\n";
			int64 speed =
				upgradeSkillType->getSpeed() +
				totalUpgrade->getProdSpeed(upgradeSkillType);
			...
			if (upgradeSkillType->getEpCost() != 0)
				...
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(upgradeSkillType->getEpCost()) + "\n";
			if (upgradeSkillType->getHpCost() != 0)
				str +=
				lang.getString("HpCost",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(upgradeSkillType->getHpCost()) + "\n";
		...
		void MorphCommandType::update(UnitUpdater * unitUpdater, Unit * unit,
			int frameIndex) const {
			unitUpdater->updateMorph(unit, frameIndex);
		}

		void MorphCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft, const UnitType & ut,
			std::map < string, vector < pair < string,
			string > > >&loadedFileList,
			...
			//morph skill
			string skillName =
				n->getChild("morph-skill")->getAttribute("value")->
				getRestrictedValue();
			morphSkillType =
				static_cast <
				const MorphSkillType *>(ut.getSkillType(skillName, scMorph));

			//morph unit
			string morphUnitName =
				n->getChild("morph-unit")->getAttribute("name")->
				getRestrictedValue();
			morphUnit = ft->getUnitType(morphUnitName);

			//discount
			discount =
				n->getChild("discount")->getAttribute("value")->getIntValue();

			ignoreResourceRequirements = false;
			if (n->hasChild("ignore-resource-requirements") == true) {
				ignoreResourceRequirements =
					n->getChild("ignore-resource-requirements")->
		...
		string MorphCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str = getName(translatedValue) + "\n";
			Lang & lang = Lang::getInstance();
			...
			//prod speed
			str +=
				lang.getString("MorphSpeed",
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(morphSkillType->getSpeed());
			...
			str +=
				...
				(translatedValue ==
					true ? "" : "english")) + ": " +
				intToStr(getMorphUnit()->getProductionTime()) + "\n";
			int64 speed =
				morphSkillType->getSpeed() +
				totalUpgrade->getProdSpeed(morphSkillType);
			...
			if (morphSkillType->getEpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(morphSkillType->getEpCost()) + "\n";
			}
			if (morphSkillType->getHpCost() != 0) {
				str +=
					...
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(morphSkillType->getHpCost()) + "\n";
			}

			//discount
			if (discount != 0) {
				str +=
					lang.getString("Discount",
					(translatedValue ==
						true ? "" : "english")) + ": " +
					intToStr(discount) + "%\n";
			}
		...
		void SwitchTeamCommandType::update(UnitUpdater * unitUpdater,
			Unit * unit, int frameIndex) const {
			unitUpdater->updateSwitchTeam(unit, frameIndex);
		}

		void SwitchTeamCommandType::load(int id, const XmlNode * n,
			const string & dir, const TechTree * tt,
			const FactionType * ft,
			const UnitType & ut, std::map < string,
			vector < pair < string,
		...
		string SwitchTeamCommandType::getDesc(const TotalUpgrade * totalUpgrade,
			bool translatedValue) const {
			string str = getName(translatedValue) + "\n";
			return str;
		}
