...
// =====================================================
    ...
    public:
      ...
      virtual void update (UnitUpdater * unitUpdater, Unit * unit,
                           int frameIndex) const = 0;
      virtual void load (int id, const XmlNode * n, const string & dir,
                         ...
                         string parentLoader);
      virtual string getDesc (const TotalUpgrade * totalUpgrade,
                              bool translatedValue) const = 0;
      virtual string toString (bool translatedValue) const = 0;
      virtual const ProducibleType *getProduced () const
      {
        return NULL;
      }
      virtual Queueability isQueuable () const
      {
        return qOnRequest;
      }
      bool isQueuable (bool tryQueue) const
      {
        Queueability q = isQueuable ();
          return (q == qAlways) || ((q == qOnRequest || q == qOnlyLast)
                                    && tryQueue);
      }
      ...
      virtual int getTypePriority () const
      {
        return 10;
      }
      ...
      const FogOfWarSkillType *getFogOfWarSkillType () const
      {
        return fogOfWarSkillType;
      };
...
// ===============================
    ...
    public:
      ...
      //get
      const StopSkillType *getStopSkillType () const
      {
        return stopSkillType;
      };

      virtual bool usesPathfinder () const
      {
        return false;
      }
    };
...
// ===============================
    ...
    public:
      ...
      //get
      const MoveSkillType *getMoveSkillType () const
      {
        return moveSkillType;
      };
...
// ===============================
    ...
    public:
      ...
      const AttackSkillType *getAttackSkillType () const
      {
...
// ===============================
    ...
    public:
      ...
      const BuildSkillType *getBuildSkillType () const
      {
        return buildSkillType;
      }
      int getBuildingCount () const
      {
        return (int) buildings.size ();
      }
      const UnitType *getBuilding (int i) const
      {
        return buildings[i];
      }
      StaticSound *getStartSound () const
      {
        return startSounds.getRandSound ();
      }
      StaticSound *getBuiltSound () const
      {
        return builtSounds.getRandSound ();
      }
...
// ===============================
    ...
    public:
      ...
      const MoveSkillType *getMoveLoadedSkillType () const
      {
        return moveLoadedSkillType;
      }
      const HarvestSkillType *getHarvestSkillType () const
      {
        return harvestSkillType;
      }
      const StopSkillType *getStopLoadedSkillType () const
      {
        return stopLoadedSkillType;
      }
      int getMaxLoad () const
      {
        return maxLoad;
      }
      int getHitsPerUnit () const
      {
        return hitsPerUnit;
      }
      int getHarvestedResourceCount () const
      {
        return (int) harvestedResources.size ();
      }
      const ResourceType *getHarvestedResource (int i) const
      {
        return harvestedResources[i];
      }
...
// ===============================
    ...
    public:
      ...
      const RepairSkillType *getRepairSkillType () const
      {
        return repairSkillType;
      };
      bool isRepairableUnitType (const UnitType * unitType) const;

      int getRepairCount () const
      {
        return (int) repairableUnits.size ();
      }
      const UnitType *getRepair (int i) const
      {
        return repairableUnits[i];
      }
...
// ===============================
    ...
    public:
      ...
      //get
      const ProduceSkillType *getProduceSkillType () const
      {
        return produceSkillType;
      }
      const UnitType *getProducedUnit () const
      {
        return producedUnit;
      }
...
// ===============================
    ...
    public:
      ...
      //get
      const UpgradeSkillType *getUpgradeSkillType () const
      {
        return upgradeSkillType;
      }
      const UpgradeType *getProducedUpgrade () const
      {
...
// ===============================
    ...
    public:
      ...
      virtual string getReqDesc (bool translatedValue) const;
      virtual const ProducibleType *getProduced () const;
      Queueability isQueuable () const
      {
        return qOnlyLast;
      }                         //After morph anything can happen

      //get
      const MorphSkillType *getMorphSkillType () const
      {
        return morphSkillType;
      }
      const UnitType *getMorphUnit () const
      {
        return morphUnit;
      }
      ...
      bool getIgnoreResourceRequirements () const
      {
